...
foi cortado para 720×1080 a partir de (99, 40), centrado no sujeito, que estava 11px à
direita do centro geométrico da imagem. `object-position` é o último recurso, para quando não dá para recortar o arquivo.
